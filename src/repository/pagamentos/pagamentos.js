...
export function salvarPagamentoDB(lancamento, callbackSucess, callbackError) {
    ...
    const params = [lancamento.id, lancamento.contadespeza, lancamento.contareceita, moment(lancamento.dataPagamento, 'YYYY-MM-DD').format('YYYY-MM-DD HH:mm:ss'), lancamento.valorPago];
